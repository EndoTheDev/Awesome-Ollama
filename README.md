...
| [Traliran AI Hub](https://github.com/traliran/traliran-ai-hub)                      |Lightweight, serverless AGPL-3.0 <br>web UI for cloud <br>and local LLMs with a built-in <br>code execution sandbox.<br>Open Source :heavy_check_mark: <br>Multi Model Chats :heavy_check_mark: <br>| [Website](https://traliran-ai-hub.netlify.app/) <br /> Download                      |
