...
| [Open WebUI Ultimate Stack](https://github.com/BitWise-0x/open-webui-ultimate-stack) | Open Source :heavy_check_mark: <br /> 35+ Pre-built Tools :heavy_check_mark: <br /> RAG with pgvector :heavy_check_mark: <br /> Private Search (SearXNG) :heavy_check_mark: <br /> ComfyUI Workflows :heavy_check_mark: <br /> Docker Swarm Support :heavy_check_mark: <br /> | Docker |
