...
| [Local Deep Research](https://github.com/LearningCircuit/local-deep-research)        | Open Source :heavy_check_mark: <br /> Deep Research with RAG :heavy_check_mark: <br /> Multi-source search (arXiv, PubMed, Web) :heavy_check_mark: <br /> Encrypted local storage :heavy_check_mark: <br /> | Docker <br /> pip                                                                                                                                                 |
